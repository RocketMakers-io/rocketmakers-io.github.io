...
안의 기능들을 만들기 이전에 slack과 통신할 event api부터 생성해보자.
...
이제 slack에서 request가 어떻게 들어오는 지 알아야한다.
...
하지만 사용자가 `내역` 이라고 검색했다고 해서 `내역` 만 내려오지 않아 해당 텍스트에 `내역` 이라는 단어가 있는지 검색했다.
...
Django의 timezone utc를 설정하면 해당 모델에서 날짜와 시간을 뽑았을 때의 기본은 utc가 된다. 따라서 해당 날짜를 timezone aware 형식으로 변경해야하기 때문에 Util에는 해당 기능들을 넣어놓았다.
...
그리고 Manager에는 이를 이용하여 출근과 퇴근시간을 체코 시간에 맞춰 변경해 메시지에 담아 보내고 있다.
...
### 출근!
<img src='https://github.com/Tirrilee/tirrilee.github.io/blob/master/images/Screenshot%202020-01-31%20at%2011.37.30.png' width='200px'/>

### 점심!
<img src='https://github.com/Tirrilee/tirrilee.github.io/blob/master/images/Screenshot%202020-01-31%20at%2011.37.39.png' width='200px'/>

### 퇴근 해야죠!
<img src='https://github.com/Tirrilee/tirrilee.github.io/blob/master/images/Screenshot%202020-01-31%20at%2011.37.45.png' width='200px'/>

### 신나는 퇴근
<img src='https://github.com/Tirrilee/tirrilee.github.io/blob/master/images/Screenshot%202020-01-31%20at%2011.37.52.png' width='200px'/>
