...
- 정재호 : 웹에 대해서는 아직 시작한지 얼마 안됬지만, 관심은 있습니다.
- 박정환 : 세종대학교에 재학중이며, 장고를 경험 해보고 싶어서 지원하였습니다.
- 박이슬 : 디자인 분야의 석사 과정에 있고, 풀스택으로 일하고 싶어서 스터디에 참여하였습니다.
- 정석영 : 공학 석사를 그만두고 웹 쪽으로 일하려고 준비 중입니다.
- 이수영 : 중앙대학교 생명공학과이며 웹에 관심이 있어서 잘은 모르지만 방학 때 프로그래밍을 해보고 싶어서 참석하게 되었습니다.
- 황소흠 : UX 디자인 연구를 하다가 데이터 시각화쪽에 관심이 생겨서 frontend 쪽 개발을 진행해 본 경험이 있습니다. 학교에서 기초적으로 python을 공부했지만, Python에 더욱 관심이 있어서 참석하게 되었습니다.
- 최주혁 : 개발자로 일한지 1년이 되었고, 장고를 회사에서 처음 시작했는데, 장고를 앱 용으로 api서버 만들어본 경험이 있습니다.
